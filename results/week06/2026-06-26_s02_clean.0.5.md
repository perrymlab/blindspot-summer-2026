...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week01/S02_clean_0.5 
  --z-threshold 0.5
```bash
```
...
```text
Which cameras were flagged?c01 and c03
Were those the cameras the poison was injected into?no this was the clean run
