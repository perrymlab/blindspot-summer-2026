...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S08_poisoned_0.5 
  --z-threshold 0.5
```bash
...
-------|---------------|----------|------------|---------|--------
  ...
  c02  | 0.559958      |0.006897  |    1606    |0.674491 |True
...
Were those the cameras the poison was injected into?c01 and c02 were poisoned
Did mean distance drop on the poisoned cameras compared to clean?yes
What does that tell you about whether the detector is working?That it is too sensitive since it is flagging everything
