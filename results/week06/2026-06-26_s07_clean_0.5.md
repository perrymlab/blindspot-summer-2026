...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S07_clean_0.5 
  --z-threshold 0.5
```bash
...
-------|---------------|----------|------------|---------|--------
  ...
  c03  | 0.563952      |0.021976  |    1940    |0.674491 |True
```

## Interpretation 

```text
Which cameras were flagged?All of the cameras flagged
...
```text
Anything that looked wrong or surprising:co2 z-score of 78.9
