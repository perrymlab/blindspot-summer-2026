...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S03_poisoned_0.5 
  --z-threshold 0.5
```bash
...
-------|---------------|----------|------------|---------|--------
  c01  | 0.599554      |0.023937  |   370      |0.694475 |True
  c02  | 0.577616      |0.016684  |   431      |0.674491 |True
...
Were those the cameras the poison was injected into?Two of the three of them were poisoned
Did mean distance drop on the poisoned cameras compared to clean?yes
What does that tell you about whether the detector is working?it tells me that it's too sensitive
What would you try next (different threshold, different scenario)?I would run it again with a higher threshold
```
