...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S05_poisoned_1.0 
  --z-threshold 1.0
```bash
...
What does that tell you about whether the detector is working?That the detector is working but not flagging everything it needs to
