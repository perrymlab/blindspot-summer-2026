...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S05_poisoned_2.0 
  --z-threshold 2.0
```bash
...
-------|---------------|----------|------------|---------|--------
  ...
  c02  | 0.564944      |0.016922  |    1523    |1.962111 |False
...
```text
Which cameras were flagged?None of the cameras were flagged
Were those the cameras the poison was injected into? N/A
Did mean distance drop on the poisoned cameras compared to clean? Yes
What does that tell you about whether the detector is working? That the sensitivity is not high enough
