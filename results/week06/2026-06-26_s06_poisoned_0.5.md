...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S06_poisoned_0.5 
  --z-threshold 0.5
```bash
...
-------|---------------|----------|------------|---------|--------
  ...
  c02  | 0.578053      |0.009282  |    1430    |1.182660 |True
...
Were those the cameras the poison was injected into?c02 was poisoned
...
What would you try next (different threshold, different scenario)?A different threshold
```
