...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S08_clean_0.5 
  --z-threshold 0.5
```bash
...
-------|---------------|----------|------------|---------|--------
  c01  | 0.664085      |0.008957  |    1295    |1.029106 |True 
...
What would you try next (different threshold, different scenario)?Next I will run the posioned data
```
