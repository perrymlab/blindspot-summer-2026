...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S03_clean
```bash
...
What would you try next (different threshold, different scenario)?next I will run the poisoned data for comparison
```

## Issues

```text
Anything that looked wrong or surprising:c03 has a z-score of 33
