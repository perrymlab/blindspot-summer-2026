...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S06_poisoned_1.0 
  --z-threshold 1.0
```bash
...
What does that tell you about whether the detector is working? the detector is picking up some poisoned embeddings just not all
