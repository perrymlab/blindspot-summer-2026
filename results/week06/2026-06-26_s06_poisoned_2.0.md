...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S06_poisoned_2.0 
  --z-threshold 2.0
```bash
...
-------|---------------|----------|------------|---------|--------
  ...
  c03  | 0.702490      |0.018574  |    585     |1.795673 |False
```
...
What does that tell you about whether the detector is working?This threshold was not sensitive enough for the detector to pick anything up
