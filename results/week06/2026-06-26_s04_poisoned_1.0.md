...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S04_poisoned_1.0 
  --z-threshold 1.0
```bash
...
What does that tell you about whether the detector is working?It falsely flagged the clean embeddings, but did not pick up the poisoned embeddings
