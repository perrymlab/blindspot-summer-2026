...
python scripts/analyze_embedding_export.py \
  ...
  --out-dir results/week06/S05_clean_2.0 
  --z-threshold 2.0
```bash
...
Were those the cameras the poison was injected into?This is the clean run
...
```text
Anything that looked wrong or surprising:The z-score for c01 is kind of high
