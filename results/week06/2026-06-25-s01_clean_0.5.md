...
Epsilon (from filename, e.g. 0.5):None
```
...
-------|---------------|----------|------------|---------|--------
  ...
  c02  |  0.531347     |0.030225  |   2488     |0.674491 |True
  c03  |  0.566363     |0.04693   |   1758     |0.000000 |True
```
...
What would you try next (different threshold, different scenario)?next I will run the poisoned data at the same threshold
```
